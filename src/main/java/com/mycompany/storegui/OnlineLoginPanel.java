        ...
        btnforgotPassword.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(OnlineRegistrationPanel.CUSTOMERS.containsKey(email))
                    JOptionPane.showMessageDialog(null, "Message sent to your email and mobile", "Information", JOptionPane.INFORMATION_MESSAGE);
                else
        ...
        btnLogin.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
               if(OnlineRegistrationPanel.CUSTOMERS.containsKey(emailField.getText())){
                    if(OnlineRegistrationPanel.CUSTOMERS.get(emailField.getText()).getPassword().equals
                            (Arrays.toString(passwordField.getPassword()))){    //if entered password matches with password in system
